...
<div class="container">
    ...
    <form class="form-signin" action="login.bit" method="post">
        <input type="text" class="form-control" name="m_id" id="inputEmail" placeholder="아이디">
        <input type="password" class="form-control" name="m_pwd" id="inputPassword" placeholder="비밀번호">
       
        <div class="row form-btn">
            <button id="loginBtn" class="btn btn-large btn-warning" type="submit">로그인</button>
