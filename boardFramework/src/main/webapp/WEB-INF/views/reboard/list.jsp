...
<form name="listForm" method="post" style="margin: 0px">
	<div class="row">
		...
		<div class="col-md-8">
			<div>
				<h3>
					<img src="${root}/img/board/m_icon_board.gif" width="9" height="9"
						border="0" align="absmiddle" style="margin-top: -2px"> <b>자유게시판</b>
					&nbsp;
				</h3>
				<h5>
					<font style="font-size: 8pt"> </font>&nbsp; 자유로운 글을 올리는 공간입니다
				</h5>
				<br>
			</div>
			...
			<div>
				<span> <img class="writeBtn"
					src="${root}/img/board/btn_write_01.gif" width="64" height="22"
					border="0" align="absmiddle" alt="글쓰기">
				</span> <span width="100%" style="padding-left: 6px" valign="bottom">새글
					<b><font class="text_acc_02">${navigator.newArticleCount }</font></b>
					/ 전체 <font class="text_acc_02">${navigator.totalArticleCount }</font>
				</span> <span width="300" nowrap></span>
			</div>
				...
				<tr>
					...
					<td nowrap><select name="key" id="skey" class="inp">
						...
						border="0" align="absmiddle" alt="검색" id="searchBtn"> <c:if
							test="${userInfo != null}">
							<img src="${root}/img/board/sbtn_mytext.gif" width="82"
								height="20" align="absmiddle" alt="내가 쓴 글 보기" id="myBtn">
						</c:if> <br></td>
